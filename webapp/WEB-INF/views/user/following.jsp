		...
		<div id="container">
			...
			<div id="follow-main">
				<div id="follow-menu" class="clearfix">
					<ul>
						<li class="page-follow following-active"><a target="_self" href="${pageContext.request.contextPath}/followerfollowing/following">팔로잉</a></li>
						<li class="page-follow"><a target="_self" href="${pageContext.request.contextPath}/followerfollowing/followers">팔로워</a></li>
					</ul>
				</div>

				<div id="follow-content" class="clearfix">
					<div class="user">
						<c:forEach items="${followingList }" var="followingVo">
							<div class="users">
								<a href="${pageContext.request.contextPath}/mycloset/${followingVo.id }/main">
									&nbsp;&nbsp;&nbsp;&nbsp;
									<img class="profile" src="${pageContext.request.contextPath}/profile/${followingVo.profileImg}">
									${followingVo.nickName }(${followingVo.id })님
								</a>
							</div>
						</c:forEach>
					</div>
